...
public class AudioManager_planet : MonoBehaviour
{
	//Audio Clips
	...
	public AudioClip introPause;
	public AudioClip introGame;
	public AudioClip nowGame;

	public static AudioManager_planet am;
	...
	public void PlayIntroPause()
	{
		audioSource.PlayOneShot(introPause);
	}

	public void PlayIntroGame()
	{
		audioSource.PlayOneShot(introGame);
	}

	public void PlayNowGame()
	{
		audioSource.PlayOneShot(nowGame);
	}

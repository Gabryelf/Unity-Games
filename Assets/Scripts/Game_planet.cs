...
public class Game_planet : MonoBehaviour 
{
	...
	void Start ()
	{
		...
		CameraController_planet.c.SetMenuView();
		UI.ui.SetMenuUI();
		UI.ui.gameUI.SetActive(false);

		//Getting the highscore.
		gameTimeHighscore = PlayerPrefs.GetFloat("Highscore_planet");
	}
	...
	{
		PlayerPrefs.SetFloat("Highscore_planet", gameTime);
	}
